...
import { isMapDevSaveAvailable } from '../utils/mapDevSave';
        ...
        MAP_REGISTRY.forEach((entry) => {
            ...
            card.innerHTML = `
                ...
                <div style="display:flex;flex-direction:column;gap:4px;flex-shrink:0;">
                    ...
                    ${isMapDevSaveAvailable() ? `<button type="button" class="floor-btn mm-save-dev" data-id="${entry.id}" style="font-size:10px;padding:4px 8px;border-color:#22c55e;color:#22c55e;">💾 public/maps</button>` : ''}
